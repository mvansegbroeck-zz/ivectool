...
///////////////////////////////////////////////////////////////////////////
#define ASSERT2(CND,MSG) if (!(CND)) {fprintf(stderr, "%s\n", MSG);exit(3);}
#define ASSERT3(CND,MSG,PTM) if (!(CND)) {fprintf(stderr, MSG, PTM);exit(3);}
#define ASSERT4(CND,MSG,PTM1,PTM2) if (!(CND)) {fprintf(stderr, MSG, PTM1,PTM2);exit(3);}
#define ASSERT5(CND,MSG,PTM1,PTM2,PTM3) if (!(CND)) {fprintf(stderr, MSG, PTM1,PTM2,PTM3);exit(3);}
#define WARNING2(MSG,PTM) fprintf(stderr, MSG, PTM);
#define WARNING3(MSG,PTM1,PTM2) fprintf(stderr, MSG, PTM1,PTM2);
/*
